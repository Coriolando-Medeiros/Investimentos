    ...
    def investir
        ...
        #loop do
            ...
            if escolha == 1
                ...
                dados_formatados = "Investimento: #{@investimentos[:investimento]}, Retorno: #{'%.1f' % @investimentos[:retorno]} %, Aporte inicial: R$ #{'%.2f' % @investimentos[:aporte]}"
                ...
                @investimentos = { investimento: investimento, retorno: retorno, aporte: aporte_inicial}
                dados_formatados = "Investimentos: #{@investimentos[:investimento]}, Retorno: #{'%.1f' % @investimentos[:retorno]} %, Aporte inicial: R$ #{'%.2f' % @investimentos[:aporte]}"
